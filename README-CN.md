...
[English](https://github.com/alibabacloud-automation/terraform-alicloud-build-local-to-cloud-active-passive-connection-with-sdwan/blob/main/README.md) | 简体中文
...
![image](https://raw.githubusercontent.com/alibabacloud-automation/terraform-alicloud-build-local-to-cloud-active-passive-connection-with-sdwan/main/scripts/diagram-CN.png)

## 用法

<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?source=Module&activeTab=document&sourcePath=alibabacloud-automation%3A%3Abuild-local-to-cloud-active-passive-connection-with-sdwan&spm=docs.m.alibabacloud-automation.build-local-to-cloud-active-passive-connection-with-sdwan" target="_blank">
...
* [完整示例](https://github.com/alibabacloud-automation/terraform-alicloud-build-local-to-cloud-active-passive-connection-with-sdwan/tree/main/examples/complete)
